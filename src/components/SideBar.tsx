        ...
        <section className={`fixed left-0 top-0 bottom-0 text-white 
            ...
            <div className={`transition-all duration-200 flex h-screen 
                ...
                <div className="flex flex-col w-64 p-2 bg-gray-900">
                    ...
                    <div onClick={onNewChat} className="flex items-center p-3 mb-2 rounded-md
                ...
                <div onClick={onClose} className="flex justify-center items-center w-10 h-10 cursor-pointer bg-red-200 md:hidden">
